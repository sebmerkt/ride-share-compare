...
public abstract class RideShareStreamerBase {
    ...
    static final String TOPICIN = "ride-share-input-test6";
    static final String TOPICOUT = "ride-share-output-test6";
    ...
    static StreamsConfig initConfig() {
        ...
        props.put(StreamsConfig.CLIENT_ID_CONFIG, "rides-test6");
