...
def make_figure(n,input_value):
  ...
  try:
    ...
    df_lyft_new = lyft_data[ (lyft_data.dropna().dolocationid.astype("float")>0) ]
    df_lyft_old = lyft_data[ (lyft_data.dolocationid.isna()) ]
    ...
    df_uber_new = uber_data[ (uber_data.dropna().dolocationid.astype("float")>0) ]
    df_lyft_old = lyft_data[ (uber_data.dolocationid.isna()) ]
